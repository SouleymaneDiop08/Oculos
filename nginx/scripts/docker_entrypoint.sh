...
if [[ -f "${NGINX_LANDING_INDEX_HTML}" ]]; then
  ...
  if [[ "$NGINX_AUTH_MODE" == "ldap" ]]; then
    ...
    AUTH_DESC="Oculos is using <a href=\"readme/docs/authsetup.html#AuthLDAP\">LDAP</a> for authentication"
    AUTH_LINK="/readme/docs/authsetup.html#AuthLDAP"
  elif [[ "$NGINX_AUTH_MODE" == "keycloak" ]]; then
    AUTH_TITLE="Keycloak Authentication"
    AUTH_DESC="Oculos is using <a href=\"readme/docs/authsetup.html#AuthKeycloak\">Keycloak</a> for authentication"
    AUTH_LINK="/keycloak/"
  elif [[ "$NGINX_AUTH_MODE" == "keycloak_remote" ]]; then
    AUTH_TITLE="Keycloak Authentication"
    AUTH_DESC="Oculos is using a remote <a href=\"readme/docs/authsetup.html#AuthKeycloakRemote\">Keycloak</a> for authentication"
    ...
    AUTH_DESC="Manage the <a href=\"/readme/docs/authsetup.html#AuthBasicAccountManagement\">local user accounts</a> maintained by Oculos"
    AUTH_LINK="/auth/"
  fi
